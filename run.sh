...
SEGMENTER_COMMAND_L="$SEGMENTER_CMD -w $OPTION1 -t $TARGET_DURATION $ADDRESS:$PORT_L -s $SLIDING_WINDOW -D -T -f ./$WEB_L/"
SEGMENTER_COMMAND_P="$SEGMENTER_CMD -w $OPTION1 -t $TARGET_DURATION $ADDRESS:$PORT_P -s $SLIDING_WINDOW -D -T -f ./$WEB_P/"
SEGMENTER_COMMAND_O="$SEGMENTER_CMD -w $OPTION1 -t $TARGET_DURATION $ADDRESS:$PORT_O -s $SLIDING_WINDOW -D -T -f ./$WEB_O/"
